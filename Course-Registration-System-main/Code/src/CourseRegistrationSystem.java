...
public class CourseRegistrationSystem {
    ...
    public void addStudent(Student student) {
        ...
        addUser(student.getName(), student.getId(), "student", student.getEmail());
        saveStudentsToFile();
    ...
    public void modifyUserEmail(String username, String role, String newEmail) {
        for (User user : users) {
            if (user.getUsername().equalsIgnoreCase(username) && user.getRole().equalsIgnoreCase(role)) {
                user.setEmail(newEmail);
                saveUsersToFile();
                System.out.println("Email updated successfully for " + username + ".");
                return;
            }
        }
    ...
    public void removeUserByUsernameAndRole(String username, String role) {
        ...
        while (iterator.hasNext()) {
            ...
            if (user.getUsername().equalsIgnoreCase(username) && user.getRole().equalsIgnoreCase(role)) {
                iterator.remove();
                saveUsersToFile();
                System.out.println("User \"" + username + "\" with role \"" + role + "\" removed successfully.");
                return;
            }
        }
        System.out.println("User \"" + username + "\" with role \"" + role + "\" not found.");
    ...
    public void viewUserDetails(String username, String role) {
        for (User user : users) {
            if (user.getUsername().equalsIgnoreCase(username) && user.getRole().equalsIgnoreCase(role)) {
